...
export interface IRandaoInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "commit"
      | "follow"
...
export interface IRandao extends BaseContract {
  connect(runner?: ContractRunner | null): IRandao;
  waitForDeployment(): Promise<this>;

  interface: IRandaoInterface;
